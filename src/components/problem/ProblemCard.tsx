...
type Props = {
  ...
  /** Optional: animate/hide delete button during stack transitions */
  deleteOpacity?: number; // 0..1
};
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative w-full overflow-visible">
            ...
            <div className="relative w-full">
              ...
              <div className="absolute left-1/2 -translate-x-1/2 -bottom-6 flex items-center">
                ...
                <div className="-ml-2 z-10 rounded-sm fontfunky bg-black px-5 py-2 text-white text-base font-semibold rotate-[-4deg]">
                  <span className="inline-block">{typeLabel}</span>
                </div>
              </div>
            </div>
          ) : (
          ...
          {onDelete && (
            <button
              ...
              className="absolute right-3 z-10 text-xs top-3 rounded-full bg-white/70 p-2 shadow-sm backdrop-blur hover:bg-white transition-opacity duration-300"
        ...
        {/* attempt actions remain commented in your version */}
      </Card>
    </div>
  );
}
